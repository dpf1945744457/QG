<template>
  <div class="container">
    ...
    <div class="container_tw">
      ...
      <div class="tw_form">
        <el-table :data="systemList"  class="table" >
      ...
      <!-- 弹出框 -->
      <el-dialog :title="addOrEdit=='add' ? '添加账号':'修改账号'" :visible.sync="dialogVisible" width="500px">
        <el-form ref="form" :model="form" label-width="140px" label-position="left" :rules="rules">
          ...
          <el-form-item label="手机号码" prop="mobilePhone">
            <el-input v-model="form.mobilePhone" placeholder="手机号码"  maxlength="11"></el-input>
          </el-form-item>
